...
2. Loads the Excel file into a pandas DataFrame using QSDsan's load_data utility

3. Defines batch_init() — a function that reads each reactor's row from the DataFrame
   and sets its initial concentrations using the appropriate QSDsan method

4. Applies initial conditions immediately when this module is imported
"""
...
# ============================================================================
# 3. Define batch initialization function
# ============================================================================
...
# ============================================================================
# 4. Apply initial conditions on import
# ============================================================================

# Calling this here means initial conditions are set automatically
# as soon as this module is imported by main.py — no manual call needed.
batch_init(sys, df)
