...
To use: in main.py, replace 'load_initial_conditions(sys)' with 'apply_startup_conditions(sys)'
Also extend the simulation duration in main.py (t = 300 recommended).
"""
...
def apply_startup_conditions(sys):
    """Seed all reactors and the clarifier with near-zero starting concentrations."""
