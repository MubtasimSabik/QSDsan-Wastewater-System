...
def make_blackwater(population):
    """
    We create a QSDsan WasteStream called 'blackwater' from per-capita loads (g/cap/d).
    ...
    Meto_g_cap_d = 1.3015
    Sulfa_g_cap_d = 0.2192
    Benzo_g_cap_d = 0.0
    Iome_g_cap_d = 0.0089324
    ...
    COD_S = 0.25 * COD_g_h   # This represents the soluable biodegradable COD later noted as S_F
